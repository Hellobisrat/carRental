...
const Banner = () => {
  return (
   ...
   bg-gradient-to-r from-[#0588FE] to-[#A9CFFF] max-w-6xl mx-3 md:mx-auto 
   rounded-2xl overflow-hidden  text-white'>
    ...
    <div>
      ...
      <p className='max-w-130'>We take care of insurance,driver verification and secure payment
