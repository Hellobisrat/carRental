...
const AddCar = () => {
  ...
  return (
    <div className='px-4 py-10 md:px-10 flex-1'>
      <Title title="Add New Car" subTitile="Fill in details to list a new car
      for booking, including pricing, availability  and car inspection"/>
      <form onSubmit={onSubmitHandler} className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl' >
       ...
       <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
        <div className='flex flex-col w-full'>
          ...
          className='px-3 py-2 mt-1 border border-boarderColor rounded-md outline-none
          ' value={car.brand} onChange={(e)=>setCar({...car,brand:e.target.value})}/>
        </div>
        <div className='flex flex-col w-full'>
          <label>Model</label>
          <input type='text' placeholder='e.g X-5, E-class...' required
          className='px-3 py-2 mt-1 border border-boarderColor rounded-md outline-none
        ...
        <div className='flex flex-col w-full'>
          ...
          <textarea rows={5} placeholder='e.g A luxurious SUV' required
          className='px-3 py-2 mt-1 border border-boarderColor rounded-md outline-none
